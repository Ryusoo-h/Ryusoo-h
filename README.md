 ...
 <div>
  <table>
    ...
    <tbody>
      ...
      <tr>
        <th width="60">참여 인원</th>
        <td>BE 1명, FE 1명 (FE 포지션 담당)</td>
      </tr>
      <tr>
        <th>기간</th>
        <td>2023.04.09~</td>
      ...
      <tr>
        ...
        <td>
          <ul>
            <li>공공 API 문서를 살펴보고 서버로부터 받은 데이터를 가공하여 원하는 UI로 출력함</li>
            <li>프록시 서버의 필요성과 CORS, SOP 개념을 학습함</li>
            <li>리액트 <code>useState</code>의 자동 일괄처리 개념 학습과 <code>startTransition</code>사용</li>
            <li>객체와 Map 자료구조의 적절한 사용</li>
            <li>UI 구현 : 날씨에 맞는 아이콘/안내 출력, 가로 스크롤 UI 출력을 위한 <code>ref</code> 활용, 등급과 그래프 UI</li>
          </ul>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <ul>
            <li>백엔드에서 Mixed content 에러 해결을 해주면, 배포할 예정</li>
            <li>배포전 리팩토링 할 예정</li>
          </ul>
        </td>
      </tr>
...
<!-- 프로젝트 추가시 사용할 수 있는 탬플릿 복사본
## 💛NewProject
💛프로젝트 설명 한줄
<a href="https://github.com/Ryusoo-h/💛NewProject"><img src="https://github-readme-stats.vercel.app/api/pin/?username=ryusoo-h&repo=💛NewProject"/></a>
<a href="https://ryusoo-h.github.io/💛NewProject/">👉 💛NewProject 보러가기</a>
<img src="💛"/>
...
<!--
**Ryusoo-h/Ryusoo-h** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
